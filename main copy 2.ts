...
export default class MyPlugin extends Plugin {
    ...
    async onload() {
        ...
        // Registering events and intervals...
        
        // Load settings when the plugin is loaded
    ...
    async getAccessToken2() {
        ...
        try {
            ...
            // Path to .cer file inside the plugin folder
            if (certPath) {
                ...
                console.error('Не удалось определить путь к файлу сертификата');
            }
        } catch (error) {
